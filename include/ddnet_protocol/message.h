...
typedef enum {
	...
	DDNET_MSG_SV_WEAPONPICKUP = 9,
	DDNET_MSG_SV_EMOTICON = 10,
	DDNET_MSG_SV_VOTECLEAROPTIONS = 11,
	DDNET_MSG_SV_VOTEOPTIONLISTADD = 12,
	DDNET_MSG_SV_VOTEOPTIONADD = 13,
	DDNET_MSG_SV_VOTEOPTIONREMOVE = 14,
	DDNET_MSG_SV_VOTESET = 15,
	DDNET_MSG_CL_SAY = 17,
